...
<main class="corDeFundo pt-3">
        ...
        <div class="row pt-5">
            <div class="col-4 quadrinhos" >
                ...
                <div>
                    ...
                    <button type="submit" class="btn btn-primary d-inline " >Comparar</button>
    ...
    <section>
        <div class="row mx-0 pt-5">
            <div class="col-4"></div>
            <div class="col-4">
                <p class="text-center fs-1">Leve um quadrinho de graça</p>
                <p class="text-center">Clique no batão e boa sorte</p>
                <div class="d-flex justify-content-center">
                <button type="submit" class="btn btn-primary" onclick="jogador1.escolha()">sorteio</button>
            </div>
            <div>
                <div class="col-4"></div>
            </div>
